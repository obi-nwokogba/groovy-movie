      ...
      url: `https://api.themoviedb.org/3/trending/all/week?api_key=0153dd9142cbca8ace6559209c3cf1aa`
           ...
           .then(
                   function (returnedData) {
                      ...
                      /*
                      $trendingBox.html(`${trendingStringStart} 
                      ${trendingStringMiddle} ${trendingStringEnd}`);
                    */
                      $trendingBox.html(`${trendingStringMiddle}`);
                   },
                   function (error) {
                      console.log("bad request: ", error);
                   }
